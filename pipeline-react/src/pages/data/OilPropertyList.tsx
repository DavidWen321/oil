...
export default function OilPropertyList() {
  ...
  const columns: ColumnsType<OilProperty> = [
      ...
      render: (val: number) => {
        ...
        return (
          <span>
            ...
            <span style={{ color: 'var(--text-muted)', fontSize: 'var(--text-xs)', marginLeft: 4 }}>kg/m³</span>
            <span
              style={{
    ...
    },
    {
      ...
      render: (val: number) => (
        <span>
          {val} <span style={{ color: 'var(--text-muted)', fontSize: 'var(--text-xs)' }}>mm²/s</span>
        </span>
      ),
    },
    {
              ...
              return (
                <div style={{
                  ...
                  <div style={{ fontSize: 13, color: 'var(--text-tertiary)', display: 'flex', flexDirection: 'column', gap: 4 }}>
                    <span>密度: <span style={{ color: cls.color }}>{record.density} kg/m³</span>（{cls.label}）</span>
                    <span>运动粘度: {record.viscosity} mm²/s</span>
                  </div>
                </div>
              );
            }}
