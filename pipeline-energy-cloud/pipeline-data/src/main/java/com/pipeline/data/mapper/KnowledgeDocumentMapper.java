...
public interface KnowledgeDocumentMapper extends BaseMapper<KnowledgeDocument> {
    ...
    @Select("""
            SELECT id,title,category,source_type,tags,remark,file_name,file_extension,file_size,file_hash,
                   storage_type,storage_bucket,storage_object_key,agent_doc_id,chunk_count,retry_count,status,
                   failure_reason,last_ingest_time,create_by,create_time,update_time,is_deleted
            FROM t_kb_document
